...
<div class="row">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <div>
                    <h6 class="card-title mb-1">Receipts</h6>
                </div>
                    ...
                    <table id="exportexample" class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                        ...
                        <tr>
                            <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                ...
                                <td><button onclick="window.location.href='doc.php?id=<?php echo $row['Payment_id']; ?>'" class="btn ripple btn-info mb-1 fe fe-printer mr-1">Print</button></td>
                            </tr>
                            <?php  endwhile; ?>
                        <tbody>
                    </table>
