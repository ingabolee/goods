...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO payment (Payment_mode, Payment_ref, Payment_amount, Payment_request_id) 
                VALUES ('CREDIT CARD', '$Payment_ref', '$Payment_amount', '$Payment_request_id')";
...
<form method="POST" action="">
    <div class="list-group-item py-4" data-acc-step>
        <h6 class="mb-0" data-acc-title>Credit Card:</h6>
        <div data-acc-content>
            <div class="my-3">
                <div class="form-group">
                    <input type="tel" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="19" placeholder="xxxx xxxx xxxx xxxx" name="card" class="form-control">
                </div>
